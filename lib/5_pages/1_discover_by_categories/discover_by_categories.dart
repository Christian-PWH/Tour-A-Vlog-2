...
class DiscoverByCategories extends StatelessWidget {
  static const routeName = '/discover_by_category';

  final Map<String, dynamic> tourByCategory;

  const DiscoverByCategories({super.key, required this.tourByCategory});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GridView.builder(
          ...
          itemCount: tourByCategory.length,
          itemBuilder: (context, index) {
            Map<String, dynamic> tourItem =
                tourByCategory[tourByCategory.keys.elementAt(index)];
