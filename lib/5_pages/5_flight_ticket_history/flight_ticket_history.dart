...
class FlightTicketHistory extends StatelessWidget {
  static const routeName = '/flight_ticket_history';

  const FlightTicketHistory({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ticket(size, context),
          heightBox(40.0),
          bookButton(size, context),
        ],
      ),
    );
  }

  bookButton(Size size, context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          getTranslate(context, 'flight_ticket.book_again'),
          style: semibold18white,
        ),
      ),
    );
              ...
              child: Row(
                children: [
                  ...
                  textColumn(getTranslate(context, 'flight_ticket.date'),
                      "07 april 2022"),
                  textColumn(getTranslate(context, 'flight_ticket.seat'), "7A"),
                ],
              ),
            ),
            Padding(
