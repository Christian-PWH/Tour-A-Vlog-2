...
class SimilarPlace extends StatefulWidget {
  static const routeName = '/similar_place';

  const SimilarPlace({super.key});

  @override
  State<SimilarPlace> createState() => _SimilarPlaceState();
}

class _SimilarPlaceState extends State<SimilarPlace> {
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image.asset(
                "assets/similarplace/Rectangle 138.png",
                fit: BoxFit.cover,
              ),
            ),
          ),
  ...
  reviewList(Size size) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslate(context, 'similar_place.review'),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                getTranslate(context, 'similar_place.view_more'),
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: fixPadding * 2),
          child: Text(
            getTranslate(context, 'similar_place.similar_places'),
            style: semibold16black,
          ),
        ),
        heightSpace,
  ...
  time() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslate(context, 'similar_place.time_visit'),
            style: semibold16black,
          ),
          height5Space,
          const Text(
  ...
  detailText() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslate(context, 'similar_place.details'),
            style: semibold16black,
          ),
          height5Space,
          const ReadMoreText(
