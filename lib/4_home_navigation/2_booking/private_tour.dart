...
class PrivateTour extends StatelessWidget {
  static const routeName = '/private_tour';

  final Map<String, dynamic> privateTourMap;

  const PrivateTour({super.key, required this.privateTourMap});
